...
// ***********************************************************************
// <copyright file="NamedPipeServer.cs" company="KsWare">
...
namespace KsWare.IO.NamedPipes {
	...
	public class NamedPipeServer : IDisposable {
		...
		/// <param name="initialNumberOfServerInstances">The initial number of server instances.</param>
		/// <autogeneratedoc />
		...
		/// <param name="maxNumberOfServerInstances">The maximum number of server instances.</param>
		/// <param name="initialNumberOfServerInstances">The initial number of server instances.</param>
		/// <param name="messageEventHandler">The message event handler.</param>
		/// <autogeneratedoc />
		public NamedPipeServer(string pipeName, int maxNumberOfServerInstances, int initialNumberOfServerInstances,
