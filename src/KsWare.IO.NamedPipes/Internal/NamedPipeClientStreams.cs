...
namespace KsWare.IO.NamedPipes.Internal {
	...
	public class NamedPipeClientStreams : NamedPipeStreams {
		...
		private void CreatePipes() {
			...
			_readPipe = new NamedPipeClientStream(".", $"{_pipeName}client", PipeDirection.In,_options);

			// Create a write pipe for sending notifications to the server.
			_writePipe = new NamedPipeClientStream(".", $"{_pipeName}server", PipeDirection.Out, _options);
